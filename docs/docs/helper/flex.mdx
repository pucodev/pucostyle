...
<PreviewCode>
  <div className="is-flex is-text-white gap-3">
    <div className="is-bg-primary p-3 rounded-md">Flex item 1</div>
    <div className="is-bg-secondary p-3 rounded-md">Flex item 2</div>
    <div className="is-bg-primary p-3 rounded-md">Flex item 3</div>
    <div className="is-bg-secondary p-3 rounded-md">...</div>
  </div>
</PreviewCode>
...
<PreviewCode>
  <div className="is-flex is-flex-row is-text-white gap-3">
    <div className="is-bg-primary p-3 rounded-md">Flex item 1</div>
    <div className="is-bg-secondary p-3 rounded-md">Flex item 2</div>
    <div className="is-bg-primary p-3 rounded-md">Flex item 3</div>
    <div className="is-bg-secondary p-3 rounded-md">...</div>
...
<PreviewCode>
  <div className="is-flex is-flex-column is-text-white gap-3">
    <div className="is-bg-primary p-3 rounded-md">Flex item 1</div>
    <div className="is-bg-secondary p-3 rounded-md">Flex item 2</div>
    <div className="is-bg-primary p-3 rounded-md">Flex item 3</div>
    <div className="is-bg-secondary p-3 rounded-md">...</div>
...
<PreviewCode>
  <div className="is-flex p-3 bg-gray-100 is-justify-content-center is-text-white gap-3">
    <div className="is-bg-primary p-3 rounded-md">Flex item 1</div>
    <div className="is-bg-secondary p-3 rounded-md">Flex item 2</div>
    <div className="is-bg-secondary p-3 rounded-md">...</div>
  </div>
...
<PreviewCode>
  <div className="is-flex p-3 bg-gray-100 is-justify-content-space-between is-text-white">
    <div className="is-bg-primary p-3 rounded-md">Flex item 1</div>
    <div className="is-bg-secondary p-3 rounded-md">Flex item 2</div>
    <div className="is-bg-primary p-3 rounded-md">Flex item 3</div>
    <div className="is-bg-secondary p-3 rounded-md">...</div>
...
<PreviewCode>
  <div className="is-flex p-3 bg-gray-100 is-align-items-center is-text-white gap-3">
    <div className="is-bg-primary p-3 rounded-md py-2">Flex item 1</div>
    <div className="is-bg-secondary p-3 rounded-md py-10">Flex item 2</div>
    <div className="is-bg-primary p-3 rounded-md py-6">Flex item 3</div>
  </div>
</PreviewCode>
...
<PreviewCode>
  <div className="is-flex is-flex-column p-3 bg-gray-100 is-align-items-center is-text-white gap-3">
    <div className="is-bg-primary p-3 rounded-md px-2">Flex item 1</div>
    <div className="is-bg-secondary p-3 rounded-md px-10">Flex item 2</div>
    <div className="is-bg-primary p-3 rounded-md px-6">Flex item 3</div>
  </div>
</PreviewCode>
